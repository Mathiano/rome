...
v0.2.15 — 2026-09-24 — §6, §3.2: Rome's first letter stands at the founding, issued at round 0; the first round no longer brings it. The one act by another actor outside a round, as part of the founding.
